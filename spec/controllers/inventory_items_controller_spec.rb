...
RSpec.describe InventoryItemsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested inventory_item as @inventory_item" do
      inventory_item = InventoryItem.create! valid_attributes
      get :show, params: {id: inventory_item.to_param}, session: valid_session
  ...
  describe "GET #new" do
    it "assigns a new inventory_item as @inventory_item" do
      ...
      get :new, params: {inventory_location_id: inventory_location.id}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested inventory_item as @inventory_item" do
      inventory_item = InventoryItem.create! valid_attributes
      get :edit, params: {id: inventory_item.to_param}, session: valid_session
      expect(assigns(:inventory_item)).to eq(inventory_item)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new InventoryItem" do
        expect {
          post :create, params: {inventory_item: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved inventory_item as @inventory_item" do
        post :create, params: {inventory_item: invalid_attributes}, session: valid_session
        expect(assigns(:inventory_item)).to be_a_new(InventoryItem)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested inventory_item" do
        inventory_item = InventoryItem.create! valid_attributes
        put :update, params: {id: inventory_item.to_param, inventory_item: new_attributes}, session: valid_session
      ...
      it "assigns the requested inventory_item as @inventory_item" do
        inventory_item = InventoryItem.create! valid_attributes
        put :update, params: {id: inventory_item.to_param, inventory_item: valid_attributes}, session: valid_session
        expect(assigns(:inventory_item)).to eq(inventory_item)
      end
    ...
    context "with invalid params" do
      it "assigns the inventory_item as @inventory_item" do
        inventory_item = InventoryItem.create! valid_attributes
        put :update, params: {id: inventory_item.to_param, inventory_item: invalid_attributes}, session: valid_session
        expect(assigns(:inventory_item)).to eq(inventory_item)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested inventory_item" do
      inventory_item = InventoryItem.create! valid_attributes
      expect {
        delete :destroy, params: {id: inventory_item.to_param}, session: valid_session
      }.to change(InventoryItem, :count).by(-1)
    end
