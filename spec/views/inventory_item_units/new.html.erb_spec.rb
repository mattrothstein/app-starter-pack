...
RSpec.describe "inventory_item_units/new", type: :view do
  before(:each) do
    assign(:inventory_item_unit, InventoryItemUnit.new(
      :inventory_item => nil,
      :checked_out_by => "MyString"
    ))
  end

  it "renders new inventory_item_unit form" do
    render

    assert_select "form[action=?][method=?]", inventory_item_units_path, "post" do
